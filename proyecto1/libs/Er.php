...
class Er {
	...
	public function valida_id_equipo($valor){
	$exp_reg = '/^(?:\+|-)?\d+$/';
	if (preg_match($exp_reg, $valor)) {
		     return true;
		} else { 
	...
	public function valida_id_estadio($valor){
	$exp_reg = '/^(?:\+|-)?\d+$/';
	if (preg_match($exp_reg, $valor)) {
		     return true;
		} else { 
	...
	public function valida_id_pais($valor){
	$exp_reg = '/^(?:\+|-)?\d+$/';
	if (preg_match($exp_reg, $valor)) {
		     return true;
		} else { 
	...
	public function valida_id_integrante($valor){
	$exp_reg = '/^(?:\+|-)?\d+$/';
	if (preg_match($exp_reg, $valor)) {
		     return true;
		} else { 
	...
	public function valida_id_continente($valor){
	$exp_reg = '/^(?:\+|-)?\d+$/';
	if (preg_match($exp_reg, $valor)) {
		     return true;
		} else { 
	...
	public function valida_id_ciudad($valor){
	$exp_reg = '/^(?:\+|-)?\d+$/';
	if (preg_match($exp_reg, $valor)) {
		     return true;
		} else { 
